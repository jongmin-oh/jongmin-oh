...
- 신규: `reflections/코더에서-문제해결사로.md` — 명제(코더 vs 문제해결사 5축 대조), 본인 궤적 4단계(코더 → 균열 → 언어 획득 → 실천), **증거 6건**(RAG 폐기 / 선톡 지표 정의 / A/B 실험 / 유리한 숫자의 자기 기각 / 운영 직접 담당 / Nightly), 자소서·면접 활용법(3문장 구조 + 원칙 4가지 + 피할 것).
