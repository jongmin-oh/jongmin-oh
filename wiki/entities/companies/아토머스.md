...
아토머스의 **인공지능팀 팀장**이 이후 [[entities/companies/레플리\|레플리]]를 창업하면서 종민을 공동창업자로 합류시켰다. 4개월이라는 짧은 재직 기간이었지만, 팀장이 종민의 역량을 눈여겨본 것이 공동창업으로 이어졌다.

## 커리어 연결고리

- Retrieval 기반 챗봇 → [[projects/personal/오복이\|오복이]](졸업작품)에서 같은 패턴 발전시킴
- 감정 위로 도메인 경험 → [[entities/companies/레플리\|레플리]] 캐릭터 챗봇의 원형
