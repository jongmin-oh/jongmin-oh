...
- **[존댓말/반말 분류기](https://huggingface.co/j5ng/kcbert-formal-classifier)** (`j5ng/kcbert-formal-classifier`) — 38,641 downloads
...
## 🧰 Skills
`Python` · `FastAPI` · `AWS (Lambda/SAM · Redis · S3)` · `React`
